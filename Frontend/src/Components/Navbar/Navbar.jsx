import { Flex, Box, Spacer, useDisclosure, Button, Divider } from "@chakra-ui/react";
        ...
        >
            ...
            >
                <Box
                    ...
                    color={location.pathname === "/aptitude" ? "aqua" : "white"}
                >
                    <Link
                        to="/aptitude"
                        fontSize="xl"
                ...
                <Box
                    ...
                    marginLeft={{ base: 0, md: 6 }}
                    _hover={{ bg: "white", color: "blue", fontWeight: "bold" }}
                    color={location.pathname === "/genraltest" ? "aqua" : "white"}
                >
                    <Link
                        to="/exam"
                        fontSize="xl"
