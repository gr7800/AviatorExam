...
const { LoginController, RegisterController, UpdatePasswordController, ProfileUpdateController, GetAllUser, deleteAuser, GetSingalUser, GetOtp } = require('./User.controller');
